/*
Author: Simon Greener (with subtle changes made myself)
...
Output: the geoms generated will have an Area >= $2 (second argument, DOUBLE
  PRECISION)

NO FUNCIONA (da NULL en los poly que tiene area menor a $2)

 */
CREATE OR REPLACE FUNCTION filter_rings2(geometry, DOUBLE PRECISION)
  RETURNS geometry AS
$BODY$
